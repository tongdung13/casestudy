        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light nav-tabs bg-primary">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <svg width="3em" height="3em" onclick="" viewBox="0 0 16 16" class="bi bi-cart-plus-fill badge-light" fill="currentColor"
                    ...
                    <path fill-rule="evenodd" d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0
                    0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zM4
                    14a1 1 0 1 1 2 0 1 1 0 0 1-2 0zm7 0a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM9 5.5a.5.5 0 0 0-1 0V7H6.5a.5.5 0 0 0 0 1H8v1.5a.5.5 0 0
                    0 1 0V8h1.5a.5.5 0 0 0 0-1H9V5.5z"/>
                </svg>
            ...
            <div class="carousel-inner col-6">
                ...
                <div class="carousel-item" style="width: 700px">
                    <img style="cursor:pointer" src="https://cdn.tgdd.vn/2020/11/banner/iphone-12-800-300-800x300-2.png"
                         alt="Sắm iPhone 12[break]Giảm Online 2 Triệu" width="630" height="300">
                </div>
                <div class="carousel-item" style="width: 700px">
                    <img style="cursor:pointer" src="https://cdn.tgdd.vn/2020/11/banner/800-300-800x300-21.png"
                         alt="dong ho thoi trang" width="630" height="300">
                </div>
            </div>
            <div class="carousel-inner col-6">
                    ...
                    <div class="col-md-3">
                        <div class="card mb-4">
                            ...
                            <div >
                                ...
                                <a style="margin-left: 75px;" href="?page=cart&id=<?php echo $row['id']; ?>" ><i class="bi bi-cart-check"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cart-check" viewBox="0 0 16 16">
