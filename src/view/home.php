                ...
                <?php foreach ($big as $key => $row): ?>
                    <div class="col-md-3">
                        <div class="card mb-4">
                            ...
                            <div>
                                <a style="margin-left: 220px;" href="?page=cart" ><i class="bi bi-cart-check"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cart-check" viewBox="0 0 16 16">
